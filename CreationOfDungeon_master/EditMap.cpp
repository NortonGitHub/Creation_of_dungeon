...
void EditMap::Init()
{
	...
	*/
	...
	std::string file_name = (IsFirstWave() ? "template" : "map" + stage_num_a);
	...
	*/
	...
	_dungeon = std::make_shared<MakeDungeon>(stage_num_a);
